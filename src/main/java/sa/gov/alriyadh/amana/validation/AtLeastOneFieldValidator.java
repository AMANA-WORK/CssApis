...
public class AtLeastOneFieldValidator implements ConstraintValidator<AtLeastOneField, CssRequestFilter> {

    @Override
    public boolean isValid(CssRequestFilter filter, ConstraintValidatorContext context) {
        if (filter == null) {
