...
import sa.gov.alriyadh.amana.entity.CssPhaseAction;
import sa.gov.alriyadh.amana.pojo.PhaseActionDetailView;
import sa.gov.alriyadh.amana.pojo.RoleActionView;

import java.util.List;

public interface CssPhaseActionRepository extends JpaRepository<CssPhaseAction, Integer> {
    ...
    List<RoleActionView[]> getUserRoleActions(@Param("userRole") Integer userRole);
